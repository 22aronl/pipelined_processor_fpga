...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_stall_queue is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_stall_queue;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_stall_queue is
...
begin
  sw(0) <= \^sw\(0);
buffers: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_stall_queue
     port map (
      CO(0) => flush0,
